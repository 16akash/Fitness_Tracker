...
def main():
    ...
    parser.add_argument("--source-repo", required=True, help="Source repository (e.g., pulkit197/fitness_tracker-fitness-app)")
    parser.add_argument("--target-repo", required=True, help="Target repository (e.g., pulkit197/fitness-tracker-prod)")
